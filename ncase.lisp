...
;;;
;;; (20210129: this file had DOS line endings!  I must have written it
;;; on a Windows machine...)
;;;

(defpackage :org.tfeb.toys.ncase
  (:use :cl)
  (:export
   #:ncase
   #:*ncase-length-threshold*
   #:*ncase-density-threshold*
   #:*ncase-predicate*))

(in-package :org.tfeb.toys.ncase)

(provide :org.tfeb.toys.ncase)
